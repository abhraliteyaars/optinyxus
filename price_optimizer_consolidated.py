...
def run_price_optimizer(upload_file_path, input_file_path):
    ...
    params = {
        'sales_constraint_lower': float(sales_constraint_lower),
        'sales_constraint_upper': float(sales_constraint_upper),
        'profit_constraint_lower': float(profit_constraint_lower),
        'profit_constraint_upper': float(profit_constraint_upper),
        'profitability_constraint_lower': float(profitability_constraint_lower),
        'profitability_constraint_upper': float(profitability_constraint_upper),
        'bosch_qty_constraint_min': int(bosch_qty_constraint_min),
        'bosch_qty_constraint_max': int(bosch_qty_constraint_max),
        'haier_qty_constraint_min': int(haier_qty_constraint_min),
        'haier_qty_constraint_max': int(haier_qty_constraint_max),
        'ifb_qty_constraint_min': int(ifb_qty_constraint_min),
        'ifb_qty_constraint_max': int(ifb_qty_constraint_max),
        'lg_qty_constraint_min': int(lg_qty_constraint_min),
        'lg_qty_constraint_max': int(lg_qty_constraint_max),
        'samsung_qty_constraint_min': int(samsung_qty_constraint_min),
        'samsung_qty_constraint_max': int(samsung_qty_constraint_max),
        'whirlpool_qty_constraint_min': int(whirlpool_qty_constraint_min),
        'whirlpool_qty_constraint_max': int(whirlpool_qty_constraint_max),
        'bosch_discount_constraint_min': float(bosch_discount_constraint_min),
        'bosch_discount_constraint_max': float(bosch_discount_constraint_max),
        'haier_discount_constraint_min': float(haier_discount_constraint_min), 
        'haier_discount_constraint_max': float(haier_discount_constraint_max),
        'ifb_discount_constraint_min': float(ifb_discount_constraint_min),
        'ifb_discount_constraint_max': float(ifb_discount_constraint_max),
        'lg_discount_constraint_min': float(lg_discount_constraint_min),
        'lg_discount_constraint_max': float(lg_discount_constraint_max),
        'samsung_discount_constraint_min': float(samsung_discount_constraint_min),
        'samsung_discount_constraint_max': float(samsung_discount_constraint_max),
        'whirlpool_discount_constraint_min': float(whirlpool_discount_constraint_min),
        'whirlpool_discount_constraint_max': float(whirlpool_discount_constraint_max)
    }
    print(query)
